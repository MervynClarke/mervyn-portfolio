...
const paragraphs = [
  ...
  "I worked my way there—managing dining for 2,000 guests for Penn State Food Services, directing Tea House Operations for the Gong Fu Cha Club, and preparing taxes for the community through VITA. Every one of those roles taught me something I still use today — how to build systems, how to serve people, and how to stay calm when it matters most.",
  'More than anything, the tea practice stayed with me. Gong Fu Cha — 功夫茶 — means “making tea with great skill,” but it’s also about using the right tools to bring out the best in what you have. It’s a diverse practice, grounded in patience, precision, and the belief that every infusion reveals something new.',
